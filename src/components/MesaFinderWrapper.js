...
export default function MesaFinderWrapper() {
  return (
        ...
        <Container>
          <Row className='text-content'>
            <Col xs={12} md={6}>
              ...
              <p>
                Revisa la oferta de mesas acá. Puedes buscar por{' '}
                <b>interés, causa o territorio</b> como también por{' '}
                <b>palabra clave.</b> ¡Súmate!
              </p>
            </Col>
            <Col xs={12} md={3}>
