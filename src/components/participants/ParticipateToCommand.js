...
export default function ParticipateToCommand({ command, show, onClose }) {
  ...
  const invite = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        setAlertMessage(
          '¡Has sido invitado a la Mesa! Pronto recibirás una invitación a tu correo'
        )
      } else {
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <p>Ingresa tus datos para completar la inscripción a el comando:</p>
