      ...
      <section className='mesas'>
        <div className='mesas-container' >
          <Row style={{marginBottom: '100px'}}>
            <Col xs={12} md={6}>
              <img src={ComoParticiparImage1} alt='¿Cómo participar?' />
            </Col>
            <Col xs={12} md={6} style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
              <div>
      ...
      <section className='consulta-ciudadana'>
        ...
        <div className='mesas-container' >
          <Row style={{marginBottom: '100px'}}>
            ...
            <Col xs={12} md={6}>
              <img src={ComoParticiparImage2} alt='¿Cómo participar?' />
            </Col>
          </Row>
        </div>
      </section>
